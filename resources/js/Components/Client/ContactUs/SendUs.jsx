...
SendUs.Input = function SendUsInput({ type, name, value, label, onChange }) {
    return (
        <div className='mb-4'>
            ...
            <input className='w-full h-10 p-2 text-sm lg:text-lg text-left rtl:text-right text-accent bg-majorBackground border-accent focus:border-accent focus:ring focus:ring-accent focus:ring-opacity-50 rounded-md shadow-sm '
                type={type}
                name={name}
                value={value}
...
SendUs.Textarea = function SendUsTextarea({ type, name, value, label, onChange }) {
    return (
        <div className='mb-4'>
            ...
            <textarea className='w-full h-40 p-2 text-sm lg:text-lg text-left rtl:text-right resize-none text-accent bg-majorBackground border-accent focus:border-accent focus:ring focus:ring-accent focus:ring-opacity-50 rounded-md shadow-sm '
                type={type}
                name={name}
                value={value}
